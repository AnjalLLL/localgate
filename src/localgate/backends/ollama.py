...
Talks to Ollama's OpenAI-compatible endpoint (http://localhost:11434/v1/chat/completions)
rather than its native /api/chat, so request/response shapes need no translation.
"""
