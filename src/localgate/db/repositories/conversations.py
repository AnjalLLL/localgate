...
class ConversationRepository:
    ...
    async def recent(
        self, session_id: str, api_key_id: str, limit: int = 20
        ...
        stmt = (
            ...
            .where(
                ...
                ConversationMessage.api_key_id == api_key_id,
            )
    ...
    async def messages_after(
        self, session_id: str, api_key_id: str, after: datetime | None
    ) -> list[ConversationMessage]:
...
class SummaryRepository:
    ...
    async def latest(self, session_id: str, api_key_id: str) -> ConversationSummary | None:
        stmt = (
